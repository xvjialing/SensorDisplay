...
//    }
    ...
    public static LatLng converter(LatLng sourseLatLng) {
        // 将GPS设备采集的原始GPS坐标转换成百度坐标
        CoordinateConverter converter = new CoordinateConverter();
        converter.from(CoordinateConverter.CoordType.GPS);
        // sourceLatLng待转换坐标
        converter.coord(sourseLatLng);
        return converter.convert();
    }

    public static List<LatLng> converterLatlngList(List<TrackPoint> trackPointList) {
        List<LatLng> latLngList = new ArrayList<>();
        for (TrackPoint point : trackPointList) {
            com.baidu.trace.model.LatLng location = point.getLocation();
    ...
    public static List<LatLng> converterList(List<EntityInfo> entities) {
        List<LatLng> latLngList = new ArrayList<>();
        for (EntityInfo point : entities) {
            com.baidu.trace.model.LatLng location = point.getLatestLocation().getLocation();
            latLngList.add(new LatLng(location.getLatitude(), location.getLongitude()));
        }
